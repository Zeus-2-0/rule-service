...
insert into rulesdb.rule_type(rule_type_sk, rule_category_sk, rule_type_id, rule_type_name, rule_type_desc, created_date, updated_date) VALUES ('a7f7a788-222c-4f86-a48c-57244439488e', '5f5390cb-6e87-4156-8f6d-8fdcbde1f62d', '3S7XXDMI3T6E0YM', 'BUSINESS_RULE', 'Business Rules to process the transaction', sysdate(), sysdate());
insert into rulesdb.rule_type(rule_type_sk, rule_category_sk, rule_type_id, rule_type_name, rule_type_desc, created_date, updated_date) VALUES ('8b19c352-b39b-4435-a983-4aaf00749b05', '5f5390cb-6e87-4156-8f6d-8fdcbde1f62d', 'WRLUYG6GYXVSNMG', 'PRE_VALIDATION_RULE', 'Rules that are to be executed before starting to process the transaction', sysdate(), sysdate());
...
insert into rulesdb.rule_set(rule_set_sk, rule_type_sk, rule_set_id, rule_set_name, rule_set_desc, active, created_date, updated_date) VALUES ('3da9c776-7ed1-473a-a92b-737e5f456dba', 'a7f7a788-222c-4f86-a48c-57244439488e','9W0HJ1CCM7B2DDJ','RATE VALIDATION', 'Rules to validate transaction rates', true, sysdate(), sysdate());
