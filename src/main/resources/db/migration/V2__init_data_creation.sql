...
insert into validationdb.rule_transaction(rule_transaction_sk, rule_sk, transaction_type_code, created_date, updated_date) VALUES ('d48b9f86-f852-4395-a4a2-96b850dd0f2f', 'd91f1ab9-35b8-4423-ab4f-acef3999f88d', 'ADD', sysdate(), sysdate());
insert into validationdb.rule_transaction(rule_transaction_sk, rule_sk, transaction_type_code, created_date, updated_date) VALUES ('6d092659-8f28-4106-b4ef-5d62d3d03f5b', 'd91f1ab9-35b8-4423-ab4f-acef3999f88d', 'CHANGE', sysdate(), sysdate());

-- END_DATE_PRESENCE mapping
insert into validationdb.rule_transaction(rule_transaction_sk, rule_sk, transaction_type_code, created_date, updated_date) VALUES ('24f81860-cf67-4cf0-bcb7-381c6caa4f72', '7227bf1d-a0f4-4d5f-b0e2-87341a732d78', 'CANCELORTERM', sysdate(), sysdate());
insert into validationdb.rule_transaction(rule_transaction_sk, rule_sk, transaction_type_code, created_date, updated_date) VALUES ('80a65d45-8360-467c-9a27-e0c208d0669a', '7227bf1d-a0f4-4d5f-b0e2-87341a732d78', 'CANCEL', sysdate(), sysdate());
insert into validationdb.rule_transaction(rule_transaction_sk, rule_sk, transaction_type_code, created_date, updated_date) VALUES ('93e26ccd-e89a-4f35-809a-55feae28bf26', '7227bf1d-a0f4-4d5f-b0e2-87341a732d78', 'TERM', sysdate(), sysdate());

-- MATCH_EFFECTIVE_DATE mapping
insert into validationdb.rule_transaction(rule_transaction_sk, rule_sk, transaction_type_code, created_date, updated_date) VALUES ('38699170-ef27-42f0-9cd6-64ae5bc843bf', '24865257-7d68-4fe9-b188-6a30092d0dac', 'ADD', sysdate(), sysdate());

-- MATCH_RATE_START_DATE mapping
insert into validationdb.rule_transaction(rule_transaction_sk, rule_sk, transaction_type_code, created_date, updated_date) VALUES ('83571fe6-2055-4260-a1f3-70ee54ce8b9d', 'e302a46c-ec4d-48af-8ac9-a21adc53e388', 'CHANGE', sysdate(), sysdate());
