...
-- Account Rule Sets
insert into rulesdb.rule_set(rule_set_sk, rule_category_sk, rule_set_id, rule_set_name, rule_set_desc, active, created_date, updated_date) VALUES ('ab13ce56-5d0d-4e7f-ac14-46fe4008ae86', '812162dd-264f-4756-a750-7dddd469c9b1','19XK4YKQOU7935V','ACCOUNT DEMOGRAPHIC', 'Rules to validate account demographics', true, sysdate(), sysdate());
insert into rulesdb.rule_set(rule_set_sk, rule_category_sk, rule_set_id, rule_set_name, rule_set_desc, active, created_date, updated_date) VALUES ('2c7fbb58-650b-4399-b5f4-50ac3b0aea98', '812162dd-264f-4756-a750-7dddd469c9b1','CMD1FNG5Y6K90U3','ENROLLMENT_SPAN', 'Rules to validate enrollment spans', true, sysdate(), sysdate());

-- Transaction Rule Sets
insert into rulesdb.rule_set(rule_set_sk, rule_category_sk, rule_set_id, rule_set_name, rule_set_desc, active, created_date, updated_date) VALUES ('097bf0a6-ac07-4573-ae42-8a986de677e3', '5f5390cb-6e87-4156-8f6d-8fdcbde1f62d','NIYHVIJRZBYT9JQ','TRANSACTION DEMOGRAPHIC', 'Rules to validate transaction demographics', true, sysdate(), sysdate());
insert into rulesdb.rule_set(rule_set_sk, rule_category_sk, rule_set_id, rule_set_name, rule_set_desc, active, created_date, updated_date) VALUES ('3da9c776-7ed1-473a-a92b-737e5f456dba', '5f5390cb-6e87-4156-8f6d-8fdcbde1f62d','9W0HJ1CCM7B2DDJ','RATE VALIDATION', 'Rules to validate transaction rates', true, sysdate(), sysdate());
-- insert into rulesdb.rule_set(rule_set_sk, rule_category_sk, rule_set_id, rule_set_name, rule_set_desc, active, created_date, updated_date) VALUES ('0bb4aba2-1cd6-48aa-a6ff-6b890da35c63', '5f5390cb-6e87-4156-8f6d-8fdcbde1f62d','ADZ465QZ4VGYEQM','EFFECTIVE DATE VALIDATION', 'Rules to validate effective date in the transaction', true, sysdate(), sysdate());
